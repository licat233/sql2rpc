...
# @LastEditors: licat
# @LastEditTime: 2023-02-16 18:24:43
...
../sql2rpc -api -db_schema="admin" -db_table="*" -service_name="admin-api" -filename="admin.api" -api_jwt="Auth" -api_middleware="AuthMiddleware" -api_prefix="api" -api_multiple=false
